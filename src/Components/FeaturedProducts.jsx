            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <button
                  ...
                  className={`flex items-center justify-center gap-2 px-4 py-2 w-full rounded-lg transition-transform transform duration-200 font-semibold ${product.owner.email === user?.email
